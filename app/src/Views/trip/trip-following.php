...
<main class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1>Trips I am Following</h1>
    </div>
    <?php require __DIR__ . '/../partials/messages.php'; ?>
    <?php if (empty($vm->trips)): ?>
        <div class="alert text-center" role="alert">
            <h2>No trips found!</h2>
            <p>You are not following any trips yet.</p>
        </div>
    <?php else: ?>
                ...
                <li class="col-md-6 col-lg-4 mb-4">
                    <article class="card h-100 shadow-sm d-flex">
                        ...
                        <div class="card-footer bg-white border-top-0 pb-3">
                            <a href="/trip/<?= htmlspecialchars($trip->id) ?>?from=collab" class="btn btn-outline-primary btn-sm w-100" aria-label="View Details for <?= htmlspecialchars($trip->title) ?>">
                               View Details
                            </a>
                        </div>
                    </article>
